...
class Game:
    ...
    def draw_finish(self):
        ...
        # w tym miejscu pojawi sie muzyka na zakonczenie
        pass
        ...
        if len(room.doors):
            for door in room.doors:
                if (
                    ...
                    # jesli wchodzimy przez dzrzwi kończymy grę
                    if not self.enter_last_door and new_room == 13:
                        self.enter_last_door = True
                        self.game_time = datatime.datatime.now() - self.start_time
    ...
    def get_key(self):
        def check_all_keys(keys):
            for any_key in keys:
                ...
                # w instracji room[8] klasy Room , lista drzwi , index 1
    ...
    def draw_scene(self):
        ...
        if self.game_start:
            ...
            self.draw_key()
            # rysujemy ukryte drzwi i mozliwośc przejścia przez nie
