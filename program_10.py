...
class Game:
    ...
    def draw_finish(self):
        ...
        screen.draw.text(
            "Koniec gry",
            (self.game_over_canvas.x - 130, self.game_over_canvas.y - 180),
            fontname="ptsansnarrowbold.ttf",
            fontsize=32,
            color=(187, 96, 191),
        )
        ...
        story = (
            f"Czas gry to: {self.game_time} \n\nKlawisz 'Q' koniec gry"
        )
        screen.draw.text(
            story,
            (self.game_over_canvas.x - 105, self.game_over_canvas.y - 0),
            fontname="ptsansnarrowregular.ttf",
            fontsize=20,
            color=(0, 0, 0),
        )
...
room_08 = Room(8, "Korytarz 04 right", 1, "corridor-04.jpg", [door_06, door_07])
